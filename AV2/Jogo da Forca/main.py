...
class HangmanGame(Frame):
    def __init__(self, master=None):
        ...
        self.image = [
            ...
            PhotoImage(file="images/forca[7].png"),
        ]
    ...
    def widgetInput(self):
        ...
        self.button = Button(self.frame, command=self.registerLog, bg="#2D3239", fg="#fff", font=self.font, text="Enviar")
    ...
    def loseCase(self):
        messagebox.showerror("Game Over!", "Sorry! Your attempts are over.", command=self.master.quit()) 
